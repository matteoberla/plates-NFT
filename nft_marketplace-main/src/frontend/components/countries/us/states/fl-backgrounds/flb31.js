...
const FlB31 = (props) => {
    ...
    <tbody>
        <tr className="rouws">
            ...
            <td>
                <input id="r46" name="radio1" value="46" onClick={getCheckboxValue.bind(this)} type="radio" /><label id="L46" htmlFor="r46"><img src="http://img03.platesmania.com/makenomer/us/fl/plates/46.png" title="Old Base" className="img-responsive" /></label>
            </td>
        </tr>
    </tbody>
</table>
